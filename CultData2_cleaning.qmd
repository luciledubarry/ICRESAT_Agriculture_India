...
base_to_join <- Cultivation_cult_distinctes |>
  select(
    ...
    FERTILIZER, LAB_TYPE, WORK_HR, NAME_MAT, TYPE_MAT, MACHINERY
  )
...
Cultivation_expand <- Cultivation_expand |>
  select(
    SUR_MON_YR, MONTH, SEASON, VDS_ID, PLOT_CODE, AREA_CROP, IRRI_CROP, CROP, DT_OPER, OPERATION, LAB_TYPE, WORK_HR, GENDER, EMPLOYMENT, NAME_MAT, TYPE_MAT, MACHINERY, FERTILIZER, VAR_TYPE, VAR_NAME, CROP_ID, HUMAN_LABOR, MULTI_CROPING, REGION, STATE, VILLAGE, everything()  # place les colonnes restantes à la fin
  )
```
